//
//  JoinPhoneNumberViewController.swift
//  Plapick
//
...
class JoinPhoneViewController: UIViewController {
    ...
    @objc func identifiedCodeTapped() {
        ...
        identifiedPhoneCodeRequest.fetch(vc: self, paramDict: ["mode": "JOIN", "ipId": String(ipId), "phoneNumber": phoneNumber, "code": code])
    }
...
extension JoinPhoneViewController: IdentifiedPhoneRequestProtocol {
...
extension JoinPhoneViewController: IdentifiedPhoneCodeRequestProtocol {
