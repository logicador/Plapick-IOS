...
//        accountViewController = AccountViewController(mainTabBarController: self)
        ...
        postingViewController?.accountVC = accountViewController
...
//        self.postingViewController?.dismiss(animated: true, completion: {
        ...
        self.postingViewController = PostingViewController(accountVC: accountViewController!)
            self.postingViewController?.delegate = self
            self.postingViewController?.accountVC = self.accountViewController
