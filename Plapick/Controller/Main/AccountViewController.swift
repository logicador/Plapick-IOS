...
class AccountViewController: UIViewController {
    ...
    lazy var myPickTitleView: TitleView = {
        let tv = TitleView(text: "나의 픽", isAction: true, actionText: "추가", actionMode: "POSTING")
        tv.delegate = self
        return tv
    }()
...
//        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "gearshape"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(setting))
        ...
        profileTopLineView.heightAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
        ...
        profileBottomLineView.heightAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
        ...
        figureTopLineView.heightAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
        ...
        followerLeftLineView.widthAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
        ...
        followerRightLineView.widthAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
...
//        ])
    ...
    override func viewDidAppear(_ animated: Bool) {
        mainVC?.title = "계정"
        mainVC?.navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "gearshape"), style: UIBarButtonItem.Style.plain, target: self, action: #selector(setting))
...
extension AccountViewController: TitleViewProtocol {
    func action(actionMode: String) {
        postingViewController = PostingViewController(accountVC: self)
//        postingViewController?.delegate = self
//        postingViewController?.accountVC = self
        ...
        if status == "OK" {
            if let pickList = pickList {
                if pickList.count == 0 {
                    ...
                    noPickBottomLineView.heightAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
                    return
                }
