...
class UploadViewController: UIViewController {
    ...
    lazy var messageTitleView: TitleView = {
        let tv = TitleView(text: "메세지 입력", actionText: nil, actionMode: nil)
        return tv
    }()
    ...
    lazy var placeTitleView: TitleView = {
        let tv = TitleView(text: "선택한 플레이스", actionText: nil, actionMode: nil)
        return tv
    }()
    ...
    lazy var imageTitleView: TitleView = {
        let tv = TitleView(text: "선택한 사진", actionText: nil, actionMode: nil)
        return tv
    }()
...
//        placeSmallView = PlaceSmallView(place: self.place!)
        ...
        imageTopLineView.heightAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
        ...
        imageBottomLineView.heightAnchor.constraint(equalToConstant: LINE_WIDTH).isActive = true
