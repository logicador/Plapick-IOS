...
//                            let user = User(id: resPick.u_id, type: resPick.u_type, socialId: resPick.u_social_id, name: resPick.u_name, nickName: resPick.u_nick_name, email: resPick.u_email, profileImageUrl: resPick.u_profile_image, likeCnt: resPick.u_like_cnt, followerCnt: resPick.u_follower_cnt, followingCnt: resPick.u_following_cnt, status: resPick.u_status, createdDate: resPick.u_created_date, updatedDate: resPick.u_updated_date)
                            
//                            let pick = Pick(id: id, pId: pId, message: message, photoUrl: photoUrl, likeCnt: likeCnt, commentCnt: commentCnt, createdDate: createdDate, updatedDate: updatedDate, user: user)
