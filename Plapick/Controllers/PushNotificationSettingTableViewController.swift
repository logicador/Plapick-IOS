...
class PushNotificationSettingTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        getPushNotificationRequest.fetch(vc: self, deviceToken: app.getPushNotificationDeviceToken())
    }
...
extension PushNotificationSettingTableViewController: SettingPushNotificationTVCellProtocol {
    func switching(action: String, isAllowed: String) {
        ...
        if isAllowed == "Y" { app.checkPushNotificationAvailable(parentViewController: self) }
        setPushNotificationRequest.fetch(action: action, isAllowed: isAllowed, deviceToken: app.getPushNotificationDeviceToken())
    }
}
